...
public class relats_review : MonoBehaviour
{
    ...
    public static void DCgetter(string RT)
    {
        ...
        DC_review.changeScript(sqliteExecuter(sqlQuery));
    ...
    public static void DSCgetter(string RT, string DC)
    {
        ...
        else sqlQuery = "Select DSC from " + tableName + " where  RT = '" + RT + "' AND DC = '" + DC + "' ;";

        DSC_review.changeScript(sqliteExecuter(sqlQuery));
    }
